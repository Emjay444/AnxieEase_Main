  ...
  try {
    ...
    if (usersData) {
      ...
      Object.keys(usersData).forEach((userId) => {
        ...
        if (userData.sessions) {
          console.log(
            `      📊 Sessions: ${Object.keys(userData.sessions).length}`
          );
        }
        if (userData.anxiety_alerts) {
          console.log(
            `      🚨 Anxiety alerts: ${
              Object.keys(userData.anxiety_alerts).length
            }`
          );
        }
      });
    ...
    if (deviceData) {
      ...
      Object.keys(deviceData).forEach((deviceId) => {
        ...
        if (device.current) {
          console.log(
            `      💓 Current heart rate: ${device.current.heartRate} BPM`
          );
