...
const url = "https://us-central1-anxieease-sensors.cloudfunctions.net/clearAnxietyRateLimits";
...
https.get(url, (res) => {
  ...
  console.log("🔧 Try manually: https://us-central1-anxieease-sensors.cloudfunctions.net/clearAnxietyRateLimits");
});