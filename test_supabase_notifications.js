...
async function testSupabaseNotifications() {
  console.log('🚀 Testing Supabase notifications (where your app actually reads from)...\n');
  ...
  try {
      ...
      .insert([
        {
          user_id: userId,
          title: '🚨 AnxieEase Anxiety Alert',
          message: 'Your heart rate is elevated (96 BPM). Are you feeling anxious or stressed?',
          type: 'anxiety',
          severity: 'mild',
          read: false,
    ...
    console.log(`📱 Found ${allNotifications.length} notifications in Supabase:`);
