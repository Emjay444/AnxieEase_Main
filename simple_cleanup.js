...
async function simpleCleanup() {
  ...
  try {
    ...
    console.log(`   Has Previous Assignment: ${assignment.previousAssignment ? 'YES (will remove)' : 'NO'}`);
    ...
    console.log("Multiple syncs created nested backups (previousAssignment → previousAssignment → ...)");
