  ...
  try {
      ...
      if (deviceData.userId) {
        ...
        if (userSnapshot.exists()) {
          ...
          if (userData.fcmToken) {
            console.log(
              `✅ FCM Token found: ${userData.fcmToken.substring(0, 20)}...`
            );
          } else {
    ...
    if (alertsSnapshot.exists()) {
      ...
      alertsSnapshot.forEach((childSnapshot) => {
        ...
        console.log(
          `     Notification Sent: ${alert.notificationSent ? "YES" : "NO"}`
        );
      });
    } else {
    ...
    console.log(
      "   This should trigger the Firebase Function if working correctly"
    );
    ...
    console.log(
      "Check your Flutter app's notification screen for stored notifications"
    );
    ...
    console.log(
      `   This should trigger a mild anxiety alert with confirmation!`
    );
