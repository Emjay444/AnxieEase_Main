...
async function analyzeNotificationSystems() {
  ...
  console.log(
    "   - Risk: ⚠️ Multiple subscriptions if app restarts frequently"
  );
  ...
  console.log(
    "   Effect: User gets multiple copies of topic-based notifications"
  );
  ...
  console.log(
    "   Channels: wellness_reminders, reminders_channel, anxiety_alerts"
  );
