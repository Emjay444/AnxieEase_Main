...
async function fixFCMAssignment() {
  ...
  try {
    ...
    if (assignment && assignment.assignedUser !== 'e0997cb7-68df-41e6-923f-48107872d434') {
    ...
    console.log('✅ FCM assignment cleaned up. Now reopen your app to generate fresh FCM token!');
    console.log('📱 Steps:');
