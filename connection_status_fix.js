...
console.log(
  "• _iotSensorService.isConnected was overriding Firebase connection"
);
...
console.log(
  "   NEW: Check for Firebase data first, then fallback to IoT service"
);
console.log("");
console.log("2. IoT Sensor Changed Handler (lines 326-335):");
console.log(
  "   OLD: Always override isConnected with _iotSensorService.isConnected"
);
