...
async function clearAndRefresh() {
  ...
  try {
    ...
    if (deviceSnapshot.exists()) {
      ...
      console.log('📱 Current FCM token timestamp:', deviceData.fcmTokenUpdated || 'Not set');
      ...
      if (ageMinutes > 30) {
        console.log(`⚠️ Token is ${Math.round(ageMinutes)} minutes old - consider refreshing`);
        console.log('🔄 To refresh: Open the app, then close it and test again');
      }
    }
