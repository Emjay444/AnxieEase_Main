...
async function testReminderReliability() {
  ...
  console.log("❌ Prevention reminders (local scheduling, may fail when app closed)");
  console.log("");
  ...
  try {
    ...
    await admin.database().ref('devices/AnxieEase001/Metrics').update({
      heartRate: 85,
      anxietyDetected: {
        severity: 'moderate',
        timestamp: Date.now(),
    ...
    console.log("✅ Firebase data updated - Cloud Function should trigger FCM notification");
    console.log("📱 CHECK YOUR DEVICE: You should see 'Moderate Alert' notification");
    ...
    console.log("📱 CHECK YOUR DEVICE: You should see 'Prevention Reminder Test'");
