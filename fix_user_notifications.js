...
async function fixUserNotifications() {
  ...
  try {
    ...
    const testNotification = {
      ...
      message:
        "Notification system is now working! This is a test from your anxiety detection system.",
      type: "test",
      severity: "mild",
      heartRate: 95,
      timestamp: Date.now(),
    ...
    const anxietyAlert = {
      title: "Anxiety Alert",
      message:
        "Your heart rate is elevated (95 BPM). Are you feeling anxious or stressed?",
      type: "anxiety",
      severity: "mild",
      heartRate: 95,
      timestamp: Date.now(),
