...
async function testSupabaseNotificationsCorrect() {
  console.log('🚀 Testing Supabase notifications with correct table structure...\n');
  ...
  try {
      ...
      .insert([
        {
          user_id: userId,
          title: '🚨 AnxieEase Anxiety Alert',
          message: 'Your heart rate is elevated (97 BPM). Are you feeling anxious or stressed? Tap to respond.',
      ...
      .insert([
        {
          user_id: userId,
          title: '💚 Wellness Check-in',
          message: 'Take a moment to breathe and check in with yourself. How are you feeling right now?',
    ...
    if (queryError) {
      ...
      allNotifications.forEach((notif, index) => {
        ...
        console.log(`      Read: ${notif.read}, Screen: ${notif.related_screen}`);
        console.log('');
      });
    }
    ...
    console.log('6. 📱 Tap notifications to test navigation to related screens');
