...
console.log('   • Disabled LOCAL breathing reminder scheduling in settings.dart');
...
console.log('✅ AFTER:  Consistent wellness_reminders and anxiety_alerts channels');
console.log('');
...
console.log('\n🎯 NEXT STEPS:');
console.log('─'.repeat(40));
console.log('1. Test the app with fresh install to verify single subscriptions');
...
console.log('• lib/services/notification_service.dart - Channel standardization & deduplication');
console.log('');
