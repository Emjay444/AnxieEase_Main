...
const supabase = createClient('https://gqsustjxzjzfntcsnvpk.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdxc3VzdGp4emp6Zm50Y3NudnBrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDEyMDg4NTgsImV4cCI6MjA1Njc4NDg1OH0.RCS_0fSVYnYVY2qr0Ow1__vBC4WRaVg_2SDatKREVHA');
...
async function testNotificationTypes() {
  ...
  const types = ['alert', 'reminder', 'anxiety_alert', 'wellness_reminder', 'system', 'emergency'];
