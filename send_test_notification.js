...
async function sendTestNotification() {
  ...
  try {
    ...
    if (!userData || !userData.fcmToken) {
      console.log(
        "❌ No FCM token found. Creating test notification in database..."
      );
      ...
      const testNotification = {
        ...
        message:
          "This is a test notification from your anxiety detection system!",
        type: "test",
        severity: "mild",
        heartRate: 95,
        timestamp: Date.now(),
      ...
      console.log(
        "📱 Open your Flutter app to see the notification on homepage/notification screen"
      );
    } else {
    ...
    if (currentData) {
      ...
      if (currentData.heartRate > 88) {
        ...
        const anxietyAlert = {
          ...
          baseline: 73.2,
          severity:
            currentData.heartRate > 108
              ? "severe"
              : currentData.heartRate > 98
              ? "moderate"
              : "mild",
          timestamp: Date.now(),
          confirmed: false,
