...
async function testWebhookResponse() {
  ...
  try {
    ...
    if (!isInSync) {
      ...
      console.log(
        "3. ⚠️  Webhook events not configured (INSERT/UPDATE/DELETE)"
      );
      ...
      console.log(
        "✅ Verify webhook URL: https://us-central1-anxieease-sensors.cloudfunctions.net/syncDeviceAssignment"
      );
    ...
    console.log("====================================");
    console.log(
      "Webhook URL: https://us-central1-anxieease-sensors.cloudfunctions.net/syncDeviceAssignment"
    );

    try {
      const testResponse = await fetch(
        "https://us-central1-anxieease-sensors.cloudfunctions.net/testDeviceSync"
      );
      ...
      console.log(
        "⚠️  Could not test Firebase Function URL (might be network issue)"
      );
    }
