...
async function investigateBaselineSyncIssue() {
  ...
  try {
    ...
    console.log("• User 1: 5afad7d4-3dcd-4353-badb-4f68... → baseline_hr: 73.2 BPM");
    console.log("• User 2: e0997cb7-684f-41e5-929f-4480... → baseline_hr: 88.2 BPM");
    console.log("");
    console.log("BASELINE TABLE (baseline_heart_rates):");
    console.log("• User 1: 5afad7d4-3dcd-4353-badb-4f68... → baseline_hr: 73.9 BPM ❌ MISMATCH!");
    console.log("• User 2: e0997cb7-684f-41e5-929f-4480... → baseline_hr: 88.2 BPM ✅ Match");
    ...
    console.log("• baseline_heart_rates.baseline_hr = User's actual profile baseline");
    console.log("• When device reassigned, user profile baseline doesn't change");
    ...
    if (userSnapshot.exists()) {
      ...
      if (userData.baseline) {
        console.log(`Firebase User Baseline: ${userData.baseline.heartRate} BPM`);
    ...
    console.log("3. ✅ Update wearable_devices.baseline_hr with user's real baseline");
    ...
    console.log("• Create Supabase function triggered on wearable_devices update");
    ...
    console.log("• When admin assigns device, auto-populate user's real baseline");
