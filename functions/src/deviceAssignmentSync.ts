 ...
 */
export const syncDeviceAssignment = functions.https.onRequest(async (req, res) => {
  // Enable CORS
 ...
 */
export const periodicDeviceSync = functions.pubsub.schedule('every 5 minutes').onRun(async (context) => {
