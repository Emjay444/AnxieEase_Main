...
exports.clearAnxietyRateLimits =
  exports.getUserFCMToken =
  exports.realTimeSustainedAnxietyDetection =
    void 0;
...
const SUPABASE_URL =
  ...
  ((_a = functions.config().supabase) === null || _a === void 0
    ? void 0
    : _a.url);
const SUPABASE_SERVICE_ROLE_KEY =
  process.env.SUPABASE_SERVICE_ROLE_KEY ||
  ((_b = functions.config().supabase) === null || _b === void 0
    ? void 0
    : _b.service_role_key);
...
function analyzeUserSustainedAnxiety(
  ...
  const allData = [
    Object.assign(Object.assign({}, currentData), { timestamp: now }),
    ...userHistoryData,
...
async function getUserFCMToken(
  userId,
  deviceId,
  notificationType = "anxiety_alert"
) {
  ...
  if (notificationType === "anxiety_alert" && deviceId) {
    ...
    if (assignmentSnapshot.exists()) {
      ...
      const fcmToken =
        assignmentData === null || assignmentData === void 0
          ? void 0
          : assignmentData.fcmToken;
      const assignedUser =
        assignmentData === null || assignmentData === void 0
          ? void 0
          : assignmentData.assignedUser;
