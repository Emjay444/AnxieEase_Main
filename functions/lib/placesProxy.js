...
exports.mapsDirections = exports.placesTextSearch = exports.placesNearbySearch = void 0;
...
async function proxyGoogleMaps(targetUrl, query, res) {
    if (!MAPS_SERVER_KEY) {
        res.status(500).json({
...
exports.placesNearbySearch = functions.https.onRequest(async (req, res) => {
    await proxyGoogleMaps("https://maps.googleapis.com/maps/api/place/nearbysearch/json", req.query, res);
});
exports.placesTextSearch = functions.https.onRequest(async (req, res) => {
    await proxyGoogleMaps("https://maps.googleapis.com/maps/api/place/textsearch/json", req.query, res);
});
exports.mapsDirections = functions.https.onRequest(async (req, res) => {
    await proxyGoogleMaps("https://maps.googleapis.com/maps/api/directions/json", req.query, res);
});
