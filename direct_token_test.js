...
const FCM_TOKEN =
  "cVkrxye5SmOUCy52tLe0fz:APA91bEErAmLuDi91mluTyG6PKjRjEvUhNV59p56kGb3AB1sll-eUjZuntXIqiM7YohpsOmrp0WKQMU0FIC6-R2BoI7ZV5wFpFltQcGOZcIHATKzsuQ5-w";
...
async function directTokenTest() {
  ...
  console.log(
    "⏳ Sending direct notification to your device in 5 seconds...\n"
  );
  ...
  try {
    ...
    console.log(
      "❌ If no notification, check battery optimization settings again."
    );
  } catch (error) {
