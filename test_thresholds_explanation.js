...
const testCases = [
  {
    hr: 90,
    expected: "mild",
    description: "Should trigger mild anxiety (90 BPM > 84 threshold)",
  },
  {
    hr: 100,
    expected: "moderate",
    description: "Should trigger moderate anxiety (100 BPM > 91 threshold)",
  },
  {
    hr: 120,
    expected: "severe",
    description: "Should trigger severe anxiety (120 BPM > 105 threshold)",
  },
  {
    hr: 140,
    expected: "critical",
    description: "Should trigger critical anxiety (140 BPM > 126 threshold)",
  },
];
